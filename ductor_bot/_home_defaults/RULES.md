...
- **Gemini CLI Warning**: Do NOT use the built-in `ask_user` tool; it is incompatible with this environment. Always use `ask_human.py` from the tools directory when interaction is needed.
